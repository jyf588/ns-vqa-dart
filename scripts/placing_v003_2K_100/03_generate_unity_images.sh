...
mkdir -p ~/data/placing_v003_2K_100/unity_output
time cp -r ~/workspace/lucas/unity/Captures/temp ~/data/placing_v003_2K_100/unity_output/images
time cp -r ~/data/temp_unity_data ~/data/placing_v003_2K_100/unity_output/json
cd ~/data
rm placing_v003_2K_100.zip
time zip -r placing_v003_2K_100.zip placing_v003_2K_100
time rsync -azP placing_v003_2K_100.zip sydney:~/mguo/data/datasets/
