...
time python enjoy.py \
    ...
    --use_obj_heights 1 \
    --save_states 1 \
    --states_dir $PARTIAL_STATES_DIR/stacking_v003_3K \
    --n_trials 3000

time python ns_vqa_dart/bullet/states/sample_states.py \
    --seed 1 \
    --src_dir $PARTIAL_STATES_DIR/stacking_v003_3K \
    --dst_dir $PARTIAL_STATES_DIR/stacking_v003_3K_100 \
    --sample_size 100

time python ns_vqa_dart/bullet/states/complete_states.py \
    --src_dir $PARTIAL_STATES_DIR/stacking_v003_3K_100 \
    --dst_dir $FULL_STATES_DIR/stacking_v003_3K_100

time python ns_vqa_dart/bullet/states/add_surrounding_states.py \
    --src_dir $FULL_STATES_DIR/stacking_v003_3K_100 \
    --dst_dir $FULL_STATES_DIR/stacking_v003_3K_100
