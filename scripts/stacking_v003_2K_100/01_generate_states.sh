...
time python ns_vqa_dart/bullet/states/sample_states.py \
    ...
    --dst_dir $PARTIAL_STATES_DIR/stacking_v003_2K_100 \
    --sample_size 100

time python ns_vqa_dart/bullet/states/complete_states.py \
    --src_dir $PARTIAL_STATES_DIR/stacking_v003_2K_100 \
    --dst_dir $FULL_STATES_DIR/stacking_v003_2K_100

time python ns_vqa_dart/bullet/states/add_surrounding_states.py \
    --src_dir $FULL_STATES_DIR/stacking_v003_2K_100 \
    --dst_dir $FULL_STATES_DIR/stacking_v003_2K_100
